...
int main(void)
{
     ...
     * @snippet point_cloud_example.cpp Connect to projector
     */
     ...
     * @snippet point_cloud_example.cpp Load projector settings
     */
     ...
     * @snippet point_cloud_example.cpp Setup projector
     */
    // [Setup projector]
     ...
     * @snippet point_cloud_example.cpp Available cameras
     */
    // [Available cameras]
     ...
     * @snippet point_cloud_example.cpp GUID
     */
    // [GUID]
     ...
     * @snippet point_cloud_example.cpp Connect to cameras
     */
    // [Connect to cameras]
     ...
     * @snippet point_cloud_example.cpp Configure cameras
     */
    // [Configure cameras]
     ...
     * @snippet point_cloud_example.cpp CoRo Eyes cameras properties
     */
     ...
     * @snippet point_cloud_example.cpp Load calibration data
     */
     ...
     * @snippet point_cloud_example.cpp Generate patterns
     */
    // [Generate patterns]
     ...
     * @snippet point_cloud_example.cpp Upload projector parameter
     */
     ...
     * @snippet point_cloud_example.cpp Print upload progress
     */
     ...
     * @snippet point_cloud_example.cpp Prepare patterns
     */
    // [Prepare patterns]
     ...
     * @snippet point_cloud_example.cpp Camera feeds
     */
    // [Camera feeds]
     ...
     * @snippet point_cloud_example.cpp Image buffers
     */
    // [Image buffers]
     ...
     * @snippet point_cloud_example.cpp Start capture
     */
    // [Start capture]
     ...
     * @snippet point_cloud_example.cpp Wait for user
     */
    // [Wait for user]
     ...
     * @snippet point_cloud_example.cpp Unregister callback
     */
    // [Unregister callback]
     ...
     * @snippet point_cloud_example.cpp Project black
     */
    // [Project black]
     ...
     * @snippet point_cloud_example.cpp Start buffering
     */
    // [Start buffering]
     ...
     * @snippet point_cloud_example.cpp Project patterns
     */
    // [Project patterns]
     ...
     * @snippet point_cloud_example.cpp Stop buffering
     */
    // [Stop buffering]
     ...
     * @snippet point_cloud_example.cpp Stop projection
     */
    // [Stop projection]
     ...
     * @snippet point_cloud_example.cpp Retrieve images
     */
    // [Retrieve images]
     ...
     * @snippet point_cloud_example.cpp Remap images
     */
    // [Remap images]
...
//        cv::destroyWindow("Remapped image (right)");
     ...
     * @snippet point_cloud_example.cpp Compute disparity map
     */
    ...
    cv::Mat rescaled_disparity_map;

    cv::resize(disparity_map, rescaled_disparity_map, cv::Size(disparity_map.size().width*scale_factor, disparity_map.size().height*scale_factor));

    cv::imshow("Disparity map", rescaled_disparity_map);
     ...
     * @snippet point_cloud_example.cpp Color disparity map
     */
    // [Color disparity map]
     ...
     * @snippet point_cloud_example.cpp Compute point cloud
     */
    // [Compute point cloud]
    ...
    /**
     * @section show_point_cloud Show the point cloud
     * @snippet point_cloud_example.cpp Show point cloud
     */
    // [Show point cloud]
...
//    myWindow.showWidget("coosys", cv::viz::WCoordinateSystem());

//    myWindow.showWidget("pointcloud", cv::viz::WPaintedCloud(point_cloud));

//    myWindow.showWidget("text2d", cv::viz::WText("Point cloud", cv::Point(20, 20), 20, cv::viz::Color::green()));
...
//#endif
     ...
     * @snippet point_cloud_example.cpp Stop captures
     */
    // [Stop captures]
     ...
     * @snippet point_cloud_example.cpp Close windows
     */
    // [Close windows]
     ...
     * @snippet point_cloud_example.cpp Disconnect
     */
    // [Disconnect]
